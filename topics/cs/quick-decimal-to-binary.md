...
1. Firstly, you need to know the powers of 2, it's easy: ```2**0 = 1```, ```2**1 = 2```, ```2**2=4```, 8, 16, 32, 64,
   128, etc.
...
So, for example you need to convert 45(decimal) to binary. The largest power of 2 and not greater than 45
is ```2**5```(32) - this is 6 bits(from 0 to 5) in binary. Let's compute it:
